...
if CLIENT then
	...
	SWEP.VElements = {
		...
		["base3"] = { type = "Model", model = "models/props_borealis/bluebarrel001.mdl", bone = "ValveBiped.Bip01", rel = "base", pos = Vector(-5, 0, 0), angle = Angle(0, 270, 90), size = Vector(0.4, 0.4, 0.4), color = Color(255, 255, 0, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
	}
	...
	SWEP.WElements = {
		...
		["base3"] = { type = "Model", model = "models/props_borealis/bluebarrel001.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "base", pos = Vector(-5, 0, 0), angle = Angle(90, 0, 0), size = Vector(0.4, 0.4, 0.4), color = Color(255, 255, 0, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
	}
end
