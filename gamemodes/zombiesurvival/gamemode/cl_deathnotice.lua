...
killicon.AddFont("prop_detpack", "zsdeathnoticecs", "I", color_white)
killicon.AddFont("weapon_zs_detpack", "zsdeathnoticecs", "I", color_white)
killicon.AddFont("weapon_zs_detpackremote", "zsdeathnoticecs", "I", color_white)
